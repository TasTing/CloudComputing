...
public class JCloudsNova implements Closeable {
    ...
    public JCloudsNova() {
        ...
        String osTenantName = "pt-27855"; //replace with appropriate tenant name
        String osUsername = "sqwang0@utas.edu.au"; //replace with appropriate user name
        String identity = String.format("%1$s:%2$s", osTenantName, osUsername); //concat osTenantName and osUsername with a ':'
        
        String credential = "MmZkZmVhZGYwMmYxODZj";//add credential
    ...
    public void createServer(){
        ...
        String imgname=new String("KIT418WorkernodeMirror");
...
//     System.out.println("\n\n"+secureApi.list());
       ...
       CreateServerOptions options1= CreateServerOptions.Builder.keyPairName("key2").
    		   securityGroupNames("ssh").userData(userdata.getBytes()); 
